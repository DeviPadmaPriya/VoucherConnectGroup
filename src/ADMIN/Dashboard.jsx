    ...
    <option value="Completed" >
      Completed Exam
        ...
        <div className="table-div">
          ...
          <TablePagination style={{ width: "70%", marginLeft: "2%" }}
                                rowsPerPageOptions={[5, 10, 25, { label: 'All', value: requests.length }]}
                                component="div"
      ...
      <div className="left-column">
        ...
        {/* <div className="left-row">
            <p><Link to={'/mainpage'} style={{ "color": "white" }}>
              <FontAwesomeIcon icon={faChartPie} size="1x" />  Voucher Overview</Link></p>
          </div> */}
          <div className="left-row">
